...
echo Package built by > target\tokanagrammar\build_notes.txt
call git var GIT_COMMITTER_IDENT >> target\tokanagrammar\build_notes.txt
echo [ ] ON DATE: %date% TIME: %time%>> target\tokanagrammar\build_notes.txt 
